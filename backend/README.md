...
## Project Structure
    ...
    ├── testapiautoteammem_102382  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_102382`
...
2. Clone this repo and `cd testapiautoteammem_102382`
